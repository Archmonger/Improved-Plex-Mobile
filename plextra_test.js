...
//////////////////Settings//////////////////////////
////////////////////////////////////////////////////
var cssBGColor = 'false';
var cssTopbarColor = 'false';
...
function loadSidebarSettings(){
	...
	if (autohideSidebar==true || (autoHideSidebarMobileOnly==true && isMobile==true)){
		...
		var hideSidebarCSS = '.page-container{margin-left:0px;} [class^="SidebarContainer-sidebarContainer-"]{transition: 0.25s;}';
		...
		hideSidebarCSS += '[class^="SidebarContainer-sidebarContainer-"] [class^="SidebarLink-title"], [class^="SidebarContainer-sidebarContainer-"] [class^="SidebarServerLibraries-librariesTitle"], [class^="SidebarContainer-sidebarContainer-"] [class^="SidebarList-sidebarListHeader"]{font-size: 0px;}[class^="SidebarContainer-sidebarContainer-"] [class^="SidebarLibrariesActions-actions"], [class^="SidebarContainer-sidebarContainer-"] [class^="SidebarLink-children"], [class^="SidebarContainer-sidebarContainer-"] [class^="ServerMenuButton-serverMenuTitle"]{display: none;}[class^="SidebarContainer-sidebarContainer-"] [class^="SidebarLibraryItem-action"]{width: 0px;}[class^="SidebarContainer-sidebarContainer-"]{width: 65px; max-width: 65px;}';
		hideSidebarCSS += '[class^="SidebarContainer-sidebarContainer-"]:hover button[data-qa-id="serverMenuButton"] div span,[class^="SidebarContainer-sidebarContainer-"]:hover div[role=navigation] div[role=header],[class^="SidebarContainer-sidebarContainer-"]:hover div[role=navigation] div a div:nth-child(2), '
		hideSidebarCSS += '[class^="SidebarContainer-sidebarContainer-"]:hover [class^="SidebarLink-title"], [class^="SidebarContainer-sidebarContainer-"]:hover [class^="SidebarServerLibraries-librariesTitle"], [class^="SidebarContainer-sidebarContainer-"]:hover [class^="SidebarList-sidebarListHeader"]{font-size: inherit;}[class^="SidebarContainer-sidebarContainer-"]:hover [class^="SidebarLibrariesActions-actions"], [class^="SidebarContainer-sidebarContainer-"]:hover [class^="SidebarLink-children"], [class^="SidebarContainer-sidebarContainer-"]:hover [class^="ServerMenuButton-serverMenuTitle"]{display: inherit;}[class^="SidebarContainer-sidebarContainer-"]:hover [class^="SidebarLibraryItem-action"]{width: inherit; max-width: inherit;}[class^="SidebarContainer-sidebarContainer-"]:hover{width: inherit; max-width: inherit;}';
